...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {textLen: a, inDropZone: b, content: c};
	});
var _user$project$Main$FilesDropped = function (a) {
	return {ctor: 'FilesDropped', _0: a};
};
var _user$project$Main$DropZoneLeaved = {ctor: 'DropZoneLeaved'};
var _user$project$Main$DropZoneEntered = {ctor: 'DropZoneEntered'};
var _user$project$Main$dropable = _norpan$elm_file_reader$FileReader$dropZone(
	{
		dataFormat: _norpan$elm_file_reader$FileReader$Text('utf8'),
		enterMsg: _user$project$Main$DropZoneEntered,
		leaveMsg: _user$project$Main$DropZoneLeaved,
		filesMsg: _user$project$Main$FilesDropped
	});
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('textarea is-primary'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$placeholder('コードをペーストしてください'),
										_1: {
											ctor: '::',
